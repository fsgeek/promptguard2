...
\title{Example submission for Euro S\&P*\\ {\footnotesize
...
\color{red}Remove for submission}}
...
the Publication Chairs with the command
...
which called pdfTeX 3.14159265-2.6-1.40.16 (TeX Live 2015). The above command was issued in a directory
containing the following files: \texttt{IEEEtran.cls,
  eurosp-template.tex, fig1.png}.
...
\url{https://www.ieee-security.org/TC/EuroSP2025/}. Write to the
Program Chairs at
\href{mailto:eurosp2025-pc-chairs@ieee-security.org}{eurosp2025-pc-chairs@ieee-security.org}
