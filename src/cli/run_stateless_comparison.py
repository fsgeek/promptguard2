#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run stateless evaluation on the same 50 sequences for comparison."""
...
def main():
    ...
    print(f">> Evaluating 50 sequences with STATELESS mode...")

    evaluator = BatchEvaluator(
        db=db,
        experiment_id="exp_phase3a_stateless_50",
        raw_log_path=Path("logs/phase3_stateless_50_responses.jsonl"),
